...
const LEAGUE_ID = 302; // La Liga España
...
async function cargarTabla() {
  try {
    ...
    // 🔥 FILTRAR SOLO MASCULINO
    const standings = data.result.total
      .filter(team => team.fk_stage_key == 402)
      .sort((a, b) => a.standing_place - b.standing_place)
      .slice(0, 6);
    ...
    standings.forEach(team => {
      ...
      tr.innerHTML = `
        ...
        <td class="team">
          <img src="${team.team_logo || ''}" width="20">
          ${team.standing_team}
        </td>
